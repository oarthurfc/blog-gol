...
export interface ApiArticlePageArticlePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    side_banner: Schema.Attribute.Relation<'oneToOne', 'api::banner.banner'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiBannerBanner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    position: Schema.Attribute.Enumeration<['top', 'middle', 'sidebar']>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiBetBet extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    differential: Schema.Attribute.String & Schema.Attribute.Required;
    link: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiPoliticaDePrivacidadePoliticaDePrivacidade
  ...
  info: {
    displayName: '/politica-de-privacidade';
...
export interface ApiTermosECondicoesTermosECondicoes
  extends Struct.SingleTypeSchema {
  collectionName: 'termos_e_condicao';
  info: {
    displayName: '/termos-e-condicoes';
    pluralName: 'termos-e-condicao';
    singularName: 'termos-e-condicoes';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::termos-e-condicoes.termos-e-condicoes'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::aposta.aposta': ApiApostaAposta;
