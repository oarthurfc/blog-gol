...
/**
 * Obter dados da página de apostas
 */
export async function getApostasPage(): Promise<ApostasPageData | null> {
  ...
  const response = await fetchContentType<ApostasPageData>("aposta", params, true);
